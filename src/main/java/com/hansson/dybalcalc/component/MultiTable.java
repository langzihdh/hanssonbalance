...
public class MultiTable extends Table{
	...
	private Object[] vecAmp;
	private Object[] vecPha;
	private MultiTableLabel[] name;
	private Object[] obj0;
	private Object[] obj1;
	private Object[] vec;
	private MultiTableLabel[] vecName;
	private int n, m;
	private MulitiTableText[] vecA0;
	private MulitiTableText[] vecT;
	private CheckBox checkBox[];
	private MulitiTableText[][] vecA1;
	private CheckBox checkBox0;
	private MulitiTableText tempText;
	private String ampA;
	private String phaA;
	...
	public MultiTable(String width, boolean tag, int n, int m){
		this.n=n;
		this.m=m;
		addContainerProperty("名称", MultiTableLabel.class, null);
