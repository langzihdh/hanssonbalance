...
import com.hansson.dybalcalc.component.TestView;
...
import com.hansson.dybalcalc.view.tools.TrialWeightPanel;
...
public final class MultiView extends Panel implements View{
    ...
    public MultiView() {
        ...
        Component doubleCalc = conWrap.wrapper(new MultiTabView());
        //doubleCalc.addStyleName("top10-revenue");
        
        doublePanel.addComponent(doubleCalc);
